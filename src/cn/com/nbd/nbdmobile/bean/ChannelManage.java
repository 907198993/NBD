...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(1, "快讯", 1, 1));
		defaultUserChannels.add(new ChannelItem(2, "资讯", 2, 1));
		defaultUserChannels.add(new ChannelItem(3, "证券", 3, 1));
		defaultUserChannels.add(new ChannelItem(4, "理财", 4, 1));
