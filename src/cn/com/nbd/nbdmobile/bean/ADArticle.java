...
@Table(TableName = "ADArticle")
public final class ADArticle implements Serializable, Parcelable {
	...
	public static final Parcelable.Creator<ADArticle> CREATOR = new Parcelable.Creator<ADArticle>() {
		public ADArticle createFromParcel(Parcel source) {
			return new ADArticle(source);
		}

		public ADArticle[] newArray(int size) {
			return new ADArticle[size];
		}
	};
}
