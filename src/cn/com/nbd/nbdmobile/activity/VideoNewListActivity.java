...
public class VideoNewListActivity extends BaseActivity implements
	...
	private void initPullView() {
		...
		params.height = BaseTools.getWindowHight(VideoNewListActivity.this)
				- getStatusBarHeight();
	...
	public void fillData(final int position, Object object) {
		...
		mMediaCtrl = new MediaController(VideoNewListActivity.this, false);
